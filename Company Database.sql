...
-- Find the sum of all employee's salaries who are male
SELECT SUM(salary) FROM employee
WHERE sex = 'M';
...
-- Find the total amount spent by client
...
-- Find any branch suppliers who are inthe label business
...
-- 2. THEY MUST HAVE A SIMILAR DATA TYPE
...
SELECT salary AS financial_Expenditures FROM employee
UNION
SELECT total_sales
FROM works_with;

-- JOINS
-- THERE FOUR TYPES OF JOIN 
-- 1. inner join
-- 2. left join
-- 3. RIGHT JOIN 
-- 4. FULL OUTER JOIN
INSERT INTO branch(branch_id, branch_name) VALUES(4, 'Baffalo');
